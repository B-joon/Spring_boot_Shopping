...
public class CartController {
    ...
    public @ResponseBody ResponseEntity order(@RequestBody @Valid CartItemVO cartItemVO,
    ...
    public @ResponseBody ResponseEntity orderCartItem(@RequestBody CartOrderVO cartOrderVO,
                                                      Principal principal) {
